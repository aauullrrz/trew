        ...
        while (true) {
            ...
            for (int i = 0; i < bookCount; i++) {
                ...
                if (book.getBookId().equals(id)) {
                    if (book.getStock() > 0) {
                        // Meminta durasi peminjaman dari pengguna
                        ...
                        // Menambahkan informasi peminjaman ke dalam daftar buku yang dipinjam
                        book.setDuration(duration); // Menyimpan durasi peminjaman pada objek Book
